  ...
  <b-container fluid>
    <b-row>
      <b-jumbotron
        ...
        header="Formulario de Finalización"
        header-level="4"
        container-fluid="1"
        align-h="center"
      ></b-jumbotron>
...
export default {
  ...
  methods: {
    ...
    formLoader() {
      this.reportData.report_type = 'Finalizado'
  ...
  watch: {
    equipmentList(newValue) {
      console.log('Equipment list set: ' + newValue)
    },
    clientList(newValue) {
      console.log('The client list set: ' + newValue)
    },
  },
  created() {
